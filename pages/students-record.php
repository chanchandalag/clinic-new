                       ...
                       <td >
                          <a class="btn btn-primary btn-sm dropdown-toggle" href="#" data-toggle="dropdown"><i class="fas fa-share-square"></i> Send</a>
                            <ul class="dropdown-menu">
                              <li>&nbsp;&nbsp;&nbsp;&nbsp;<a onclick="return confirm('Are you sure you want to send this into Medical')" href="/pages/medical-send.php?id=<?=$rows['id'];?>" class="fa fa-heartbeat"> Medical Records</a></li>
